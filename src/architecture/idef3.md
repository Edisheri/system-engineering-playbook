...
> **Примечание:** Диаграмма должна быть обновлена согласно правильной структуре IDEF3 с UOB (прямоугольники с номерами), Junction (X/XOR, O/OR, &/AND) и альтернативными путями. См. [спецификации диаграмм](diagram-specifications.md) для деталей.
