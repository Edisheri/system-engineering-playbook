...
### Структура DFD:
- **Процессы (Processes)** — кружки с номерами (P1, P2, P3, P4), преобразующие данные
- **Хранилища данных (Data Stores)** — две параллельные линии с номерами (D1, D2, D3, D4), хранят данные
- **Внешние сущности (External Entities)** — прямоугольники, источники/приёмники данных вне системы
- **Потоки данных (Data Flows)** — стрелки с подписями, показывают направление и тип данных
