...
> **Примечание:** Диаграмма должна быть обновлена согласно правильной структуре DFD с процессами (округлые прямоугольники), хранилищами данных (две параллельные линии), внешними сущностями (прямоугольники) и подписанными потоками данных. См. [спецификации диаграмм](diagram-specifications.md) для деталей.
