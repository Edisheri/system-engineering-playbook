...
### Структура IDEF0:
- **Блок функции** (Function Box) — прямоугольник с номером и названием
- **Входы (Inputs)** — слева, что преобразуется функцией
- **Выходы (Outputs)** — справа, что производит функция
- **Управление (Control)** — сверху, правила и ограничения
- **Механизмы (Mechanisms)** — снизу, ресурсы для выполнения
